...
import 'package:seccion6_componentes/src/models/actores_model.dart';
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          ...
          //SliverFillRemaining() //rellenar contenido por si no estan grande el contenido

        ],
        //shrinkWrap: false, //CORREGIR EFECTO DE APARIENCIA POR MUCHO CONTENIDO INVESTIGAR
      )
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Flexible(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start, //no lo vi necesario
              children: [
